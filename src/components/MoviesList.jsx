  ...
  movies.map((movie, index) => (
    <div key={movie.id} className="list-item">
      ...
      <Link to={`/movie/${movie.id}`} className="list-item__link">
        <img src={movie.poster_path ? `https://image.tmdb.org/t/p/w200${movie.poster_path}` : defaultPoster} alt={movie.title} className="list-item__img" />
...
MoviesList.propTypes = {
  ...
  addOrDeleteToFavourites: PropTypes.func,
};
